...
const HeroIntro = () => {
  return (
    <section className="relative text-center py-16 overflow-hidden max-w-7xl mx-auto">
      ...
      <motion.p
        className="relative text-gray-200 text-xl mt-4 mb-12 max-w-2xl mx-auto leading-relaxed opacity-90"
      ...
      <motion.div
        className="mx-auto w-32 h-1 rounded-full bg-gradient-to-r from-cyan-400 to-emerald-400 shadow-[0_0_15px_rgba(0,255,198,0.5)]"
        initial={{ scaleX: 0 }}
        animate={{ scaleX: 1 }}
